...
public class NetworkBuildConfiguration {
	...
	/**
	 * True if statistics during building network should be gained.
	 */
	private boolean useBuildingStatistics = false;
	...
	public boolean isUseBuildingStatistics() {
		return useBuildingStatistics;
	}

	public NetworkBuildConfiguration setUseBuildingStatistics(boolean useBuildingStatistics) {
		this.useBuildingStatistics = useBuildingStatistics;
		return this;
	}
